...
public class SistemaPantalla implements Runnable {
    ...
    private static final String TIPO_SERVIDOR = "Pantalla"; // O "totem", "pantalla", etc.
    private boolean ejecutando;

    public static void main(String[] args) {
        SistemaPantalla servidor = new SistemaPantalla();
